  ...
  <div v-loading="!licenceProductLoading" class="app-container">
    ...
    <div v-if="activeStep === 1">
      ...
      >
        ...
        <el-form-item label="Workflows" prop="workflows">
          <el-select
      ...
      <el-row :gutter="10">
        ...
        <el-col :sm="24" :md="showType === 'view' ? 24 : 14">
          ...
          <el-table fit highlight-current-row border size="small" :data="licenceProduct.feeStructure">
            ...
            <el-table-column label="Active" sortable align="center">
...
export default {
  ...
  data() {
    return {
      ...
      standAloneFeeStructureRules: {
        ...
        accountCode: [{ required: true, message: 'Please enter the GFS code', trigger: 'blur' },
          { min: 3, message: 'Length should be at least 3', trigger: 'blur' }],
      ...
      licenceProduct1Rules: {
        name: [
          {
            required: true,
            message: 'Please input Entity Product name',
            trigger: 'blur'
          },
          { min: 3, message: 'Length should be at least 3', trigger: 'blur' }
        ],
        displayName: [
          {
            required: true,
            message: 'Please input Entity Product Display Name',
            trigger: 'blur'
          },
          { min: 3, message: 'Length should be at least 3', trigger: 'blur' }
        ],
        code: [
          {
            required: true,
            message: 'Please input Entity Product Code',
            trigger: 'blur'
          },
        ...
        description: [
          {
            required: true,
            message: 'Please input Entity Product Description',
            trigger: 'blur'
          },
          { min: 2, message: 'Length should be at least 3', trigger: 'blur' }
        ],
  ...
  methods: {
    ...
    submitLicenceProduct() {
      ...
      updateEntityProducts(this.licenceProduct).then(response => {
        this.loadingSave = false
        this.closeDialog()
        if (response.code === statusCodes.SUCCESS) {
          this.$message({
            message: 'Entity Product updated successfully.',
            showClose: true,
            type: 'success'
          })
          this.closeDialog()
