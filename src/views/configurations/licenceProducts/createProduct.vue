  ...
  <div class="app-container">
    ...
    <div v-if="activeStep === 1">
      ...
      >
        ...
        <el-form-item label="Application Workflows" prop="workflows">
          <el-select
            ...
            placeholder="Select Application Workflows"
        ...
        <el-form-item label="Products Duration (Year(s))" prop="duration" required>
          <el-input v-model="licenceProduct.duration" type="number" />
        </el-form-item>
      ...
      <el-row :gutter="10">
        <el-col :sm="24" :md="10">
          ...
          >
            ...
            <el-form-item inline-message="GFS code" label="GFS Code" prop="code" required>
        ...
        <el-col :sm="24" :md="14">
          ...
          <el-table fit highlight-current-row border size="small" :data="licenceProduct.feeStructure">
            ...
            <el-table-column label="Fee Amount" sortable align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.feeAmount | toThousandFilter }} <b> {{ mapValueTypeById(scope.row.feeCurrency, 'currency') }} </b> </span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    submitLicenceProduct() {
      ...
      createLicenceProducts(this.licenceProduct).then(response => {
