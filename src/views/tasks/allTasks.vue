<template>
  <div class="app-container">
    ...
    >
      ...
      <!--      <el-table-column label="Application Number" size="200">-->
      <!--        <template slot-scope="scope">-->
      <!--          {{ scope.row.applicationNumber | defaultNull }}-->
      <!--        </template>-->
      <!--      </el-table-column>-->
      ...
      <!--      <el-table-column label="Licence" align="left" resizable width="300">-->
      <!--        <template slot-scope="scope">-->
      <!--          <span>{{ scope.row.displayName |defaultNull }}</span>-->
      <!--        </template>-->
      <!--      </el-table-column>-->
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getAllTasks(this.page.number, this.page.size, this.listQuery.title).then(response => {
